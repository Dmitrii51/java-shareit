...
class UserServiceDBImplTest {
    ...
    void getUserTest() {
        ...
        AssertionsForClassTypes.assertThat(userService.getUser(user1.getId())).isEqualTo(user1);
    }
    ...
    void addUserTest() {
        ...
        AssertionsForClassTypes.assertThat(userService.addUser(user1)).isEqualTo(user1);
    }
    ...
    void updateUserTest() {
        ...
        when(userRepository.save(user1)).thenReturn(user1);
        AssertionsForClassTypes.assertThat(userService.updateUser(user1, user1.getId())).isEqualTo(user1);
    }
